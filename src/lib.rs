...
use macros::{ints_create, maps_op, map_ints_op, map_contains, map_count, map_json, ints_group_create};
...
//
// #[derive(Default)]
// struct Roaring32GroupCreate {
//     map: Map32,
//     vec: Vec<u8>
// }
//
// #[register]
// impl AggregateUdf for Roaring32GroupCreate {
...
// }
// #[register]
// impl BasicUdf for Roaring32GroupCreate {
